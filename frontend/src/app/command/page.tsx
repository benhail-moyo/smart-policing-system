    ...
    <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
      <div>
        <div className="mb-2 flex items-center gap-2 text-cyan-300">
          ...
          <span className="text-xs font-bold uppercase tracking-[0.24em]">Secure command environment</span>
        </div>
        <h1 className="text-3xl font-bold">Operations Command Centre</h1>
        <p className="mt-1 text-sm text-slate-400">Coordinate deployments, strategic operations and field accountability.</p>
      </div>
      <div className="flex items-center gap-3">
        <Link href="/hotspots/trends" className="flex items-center gap-2 rounded-lg border border-slate-700 bg-slate-800 px-4 py-2 text-sm font-semibold hover:bg-slate-700">
          <TrendingUp className="h-4 w-4"/>
          Hotspot Trends
        </Link>
        <div className="rounded-xl border border-cyan-400/20 bg-cyan-400/10 px-4 py-3 text-right">
          <div className="text-xs text-cyan-200">ACTIVE DEPLOYMENTS</div>
