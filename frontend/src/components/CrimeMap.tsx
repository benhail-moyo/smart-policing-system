...
export default function CrimeMap({
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        console.warn("CrimeMap initialization error:", err);
      }
    })();
  ...
  useEffect(() => {
    ...
    try {
      ...
      for (const r of routes) {
        ...
        if (r.geometry && r.geometry.type === "LineString" && r.geometry.coordinates && r.geometry.coordinates.length > 0) {
        ...
        L.circle([h.lat, h.lng], {
          ...
          .bindPopup(
            `<div style="min-width:170px">
              <b>${(h.level || "unknown").toUpperCase()} Risk Hotspot</b><br/>
      ...
      console.warn("CrimeMap layer update error:", err);
    }
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn("CrimeMap selected marker error:", err);
    }
  }, [selected]);
